...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #conv - leakyrelu - 2x2 max pool - affine - leakyrelu - affine - softmax
        pool_layer, cache = conv_lrelu_pool_forward(X, W1, b1, conv_param, {'alpha': self.alpha}, pool_param)
        
        layer2_out, cache_fc = affine_lrelu_forward(pool_layer, W2, b2, {'alpha': self.alpha})
        
        scores, cache_fc2 = affine_forward(layer2_out, W3, b3)
        ...
        d_out, grads['W3'], grads['b3'] = affine_backward(softmax_grad, cache_fc2)
        d_out, grads['W2'], grads['b2'] = affine_lrelu_backward(d_out, cache_fc)
        d_out, grads['W1'], grads['b1'] = conv_lrelu_pool_backward(d_out, cache)
